        ...
        <form id="register-form" class="auth-form" method="post" action="<?= base_url('auth/register') ?>">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" id="age" name="age" placeholder="Sua idade atual" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" id="peso" name="peso" placeholder="Seu peso atual" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" id="altura" name="altura" placeholder="Sua altura" required>
                </div>
            </div>
